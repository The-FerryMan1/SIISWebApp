        ...
        <UForm :schema="OnBoardUpdateDtoSchema" :state="state" ref="form" @submit="debounceOnSubmit">
            ...
            <UPageCard v-if="details?.student" title="Student" description="student information"
                ...
                <UFormField label="First name" title="First name" name="firstName">
                    <UInput v-model="details.student.firstName" placeholder="enter your first name" class="w-full" />
                </UFormField>

                <UFormField label="Middle name" title="Middle Name" name="middleName">
                    <UInput v-model="details.student.middleName" placeholder="enter your middle name" class="w-full" />
                </UFormField>
                ...
                <UFormField label="Address" title="address" name="address">
                    <UInput v-model="details.student.address" placeholder="Enter your contact number" class="w-full" />
                </UFormField>
            </UPageCard>

            <!-- school details -->
            <UPageCard v-if="details?.school" title="School" description="School information" icon="i-lucide-building">
                ...
                <UFormField label="School address" title="address" name="Schooladdress">
                    <UInput v-model="details.school.address" placeholder="Enter your school addres" class="w-full" />
                </UFormField>
                ...
                <UFormField label="Contact person's number" title="Contact person number" name="ContactPersonNumber">
            ...
            <UPageCard v-if="details?.internship" title="Internship" description="Internship details"
                ...
                <UFormField label="Start date" title="Start date" name="startDate">
                    <UInput type="date" v-model="details.internship.startDate" placeholder="enter your email address"
                        class="w-full" :min="new Date().toISOString().split('T')[0]" />
                </UFormField>
                ...
                <UFormField label="Estimated end date" title="Date of Birth" name="DateofBirth"
                    ...
                    <UInput type="date" v-model="details.internship.estimatedEndDate"
                        placeholder="enter your email address" class="w-full " disabled />
                </UFormField>
            </UPageCard>
            ...
            <div class="flex w-full my-5 justify-end">
                <UModal v-model="open" title="Edit Applciation"
