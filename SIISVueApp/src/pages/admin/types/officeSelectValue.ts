...
export const OfficeNameLabels: Record<OfficeNameEnum, string> = {
  ...
  [OfficeNameEnum.OpgOfficeOfTheProvincialYouthDevelopmentOfficer]:
    'OPG-Office of the Provincial Youth Development Officer',
  ...
  [OfficeNameEnum.OpgOfficeOfTheProvincialInternalAuditServices]:
    'OPG-Office of the Provincial Internal Audit Services',
  ...
  [OfficeNameEnum.OpgOfficeOfTheProvincialPersonsWithDisabilityAffairsOfficer]:
    'OPG-Office of the Provincial Persons with Disability Affairs Officer',
  ...
  [OfficeNameEnum.ProvincialHousingAndDevelopmentManagementOffice]:
    'Provincial Housing and Development Management Office',
  [OfficeNameEnum.OfficeOfTheProvincialHumanResourceManagementOfficer]:
    'Office of the Provincial Human Resource Management Officer',
}
