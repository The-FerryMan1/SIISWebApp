      ...
      <UContainer class="flex flex-col items-center my-10">
        ...
        <div class="flex flex-col text-center justify-center items-center p-3 my-3 gap-2">
          <img
            ...
            alt="Brand Logo"
          />
          <h1 class="text-4xl font-bold text-primary uppercase tracking-tight">Student Internship Registration</h1>
          <small class="text-xs italic flex items-center flex-wrap justify-center gap-1 text-muted">
        ...
        <template v-else>
          ...
          >
            ...
            <!-- Internship Details -->
            <UPageCard title="Internship Details" icon="i-lucide-briefcase" variant="outline">
              <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <!-- Requirements -->
            <UPageCard title="Requirements" icon="i-lucide-folder-open" variant="outline">
        ...
        <UModal v-model:open="isOpen" title="Review Application" size="xl">
          <template #body>
            <div class="flex flex-col gap-5" v-if="state.student">
              ...
              <UPageCard title="Internship Details" icon="i-lucide-briefcase">
                <ul class="space-y-1">
                  <li
              ...
              <UPageCard title="Uploaded Requirements" icon="i-lucide-folder-open">
                <ul class="space-y-1">
                  <li
