...
const filteredLogs = computed(() => {
  ...
  return logs.value.filter((l: any) =>
    [l.action, l.entity, l.entityId, l.details]
      .filter(Boolean)
  ...
  <UMain class="py-6">
    <div class="flex items-center justify-between mb-4">
      <div>
        ...
        <p class="text-muted text-sm">Office activity and changes</p>
      </div>
    </div>
    ...
    <UCard>
      ...
      <div v-if="!filteredLogs?.length && !loading" class="flex items-center justify-center h-32 text-muted">
        No logs found
      </div>
