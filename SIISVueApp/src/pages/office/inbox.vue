...
const typeLabel = (type: string) => {
  switch (type) {
    ...
    case 'AdminApplicationApproved': return 'Application Approved'
    case 'AdminApplicationRejected': return 'Application Rejected'
    case 'AdminApplicationTrashed': return 'Application Removed'
    case 'AdminApplicationDeleted': return 'Application Deleted'
    default: return type
  }
}
</script>
...
<template>
  <UMain class="space-y-6">
    <div>
      ...
      <p class="text-muted text-sm mt-1">Pending tasks and notifications for your office</p>
    </div>
