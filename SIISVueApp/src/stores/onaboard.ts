...
export const useOnBoardStore = defineStore('onboard', () => {
    ...
    const toDataForm = (): FormData => {
        ...
        formData.append('internship.estimatedEndDate', state.value.internship.estimatedEndDate?.toString() ?? '')
        formData.append('internship.internshipNature', String(state.value.internship.internshipNature))
        formData.append('internship.internshipTotalHours', String(state.value.internship.internshipTotalHours))
